                    ...
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <>
                                {auth.user.is_admin ? (
                                    <>
                                        ...
                                        <Link href={route('profile.edit')}>بيانات الحساب</Link>
                                    </>
                                ) : (
                                    <>
                            ...
                            <>
                                <Link
                                    href={route('login')}
                                    className="inline-block rounded-sm border bg-teal-200 px-5 py-1.5 text-sm leading-normal text-black hover:border-[#19140035] hover:bg-teal-800 dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                                >
                                    مسجل بالفعل
                                </Link>
                                <Link
